...
/**
 * free_commands -this will  free the command's list
 * @header: this is the struct with global variables
 * Return: void
 */
...
/**
 * identify_directory - this will identify if the first argument of the buffer is a
 * directory or not
 * @to_search: this is the first argument of the buffer.
 * @envp: is an array of the strings with environment variables.
...
/**
 * super_free -is a super command to  free everything
 * @header: is the struct with global variables
 * @pathname: is the string with a pathname
 *Return: void
 */
...
/**
 * _execve -this will  execute a command if the command exist in the direcotires stored
 * in the variable PATH
 * @header: is the struct pointer.
 * Return: void
 */
