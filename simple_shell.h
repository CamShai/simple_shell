...
/**
 * struct node -s is the  structure list nodes.
 * @setenv:for  setenv value add or modify.
...
/**
 * struct commands - this is the struct to create a list of diferents commands supplied to
 * the program
 * @split_command: this is an array of pointers to strings with command and command's
 * arguments
...
/**
 * struct simple_shell - this is the struct with global variables
 * @argv: are the array arguments.
 * @envp: this will take envorinment variable.
 * @buffer: is the buffer variable.
 * @arguments: arguments.
 * @OLD_WD: OLD WORKING DIRECTORY
 * @head: this is the pointer to the head node structure.
...
/**
 * struct comparisons - is the struct to  compare function name between function
 * @comp: this is the pointer comparator with function.
...
/**
 * struct id_function - rhis is the structure of functions and id
 * @id: are the identifiers of conversion
